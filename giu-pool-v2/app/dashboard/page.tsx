              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <MapPin className="h-4 w-4 text-giu-gold" />
                    <span>{ride.from}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <MapPin className="h-4 w-4 text-giu-gold" />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-lg font-bold text-giu-gold">{ride.price}</div>
                </div>
                ...
                <Button className="w-full bg-giu-red hover:bg-giu-red/90">Book Now</Button>
              </div>
            </CardContent>
          </Card>
        ))}
